export const MOVEMENT_CAPABILITY = "movement.state";
export const MOVEMENT_EFFECT_ID = "movement.integrate";
export const MOVEMENT_SET_VELOCITY_EFFECT_ID = "movement.set-velocity";
export const MOVEMENT_ADD_VELOCITY_EFFECT_ID = "movement.add-velocity";
export const MOVEMENT_SCALE_SPEED_EFFECT_ID = "movement.scale-speed";
export const MOVEMENT_APPLY_FORCE_FIELD_EFFECT_ID = "movement.apply-force-field";
...
export function registerMovementEffect(registry) {
...
export function registerMovementCommands(registry) {
    return registry
        .register({
